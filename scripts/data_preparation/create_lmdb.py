...
def create_lmdb_for_reds():
    ...
    """
    # train_sharp
    folder_path = '/home/rpf/tgp/dataset/NTIRE_LR_Image_Deblurring/train/train_sharp'
    lmdb_path = '/home/rpf/tgp/dataset/NTIRE_LR_Image_Deblurring/train/train_sharp_ext.lmdb'
    ...
    # train_blur_bicubic
    folder_path = '/home/rpf/tgp/dataset/NTIRE_LR_Image_Deblurring/train/train_blur_bicubic/X4/images'
    lmdb_path = '/home/rpf/tgp/dataset/NTIRE_LR_Image_Deblurring/train/train_blur_bicubic_ext.lmdb'
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)

    # train_shape_bicubic
    folder_path = '/home/rpf/tgp/dataset/NTIRE_LR_Image_Deblurring/train/train_bicubic/'
    lmdb_path = '/home/rpf/tgp/dataset/NTIRE_LR_Image_Deblurring/train/train_bicubic_ext.lmdb'
    img_path_list, keys = prepare_keys_reds(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys, multiprocessing_read=True)
